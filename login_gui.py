...
if __name__ == "__main__":
    with open("C:/Users/TruongDuc/Downloads/Nhóm 16/Nhóm 16/Code/DSSV.csv", mode="r", encoding="utf-8-sig") as file:
    ...
    #Chèn ảnh
    img = PhotoImage(file='C:/Users/TruongDuc/Downloads/Nhóm 16/Nhóm 16/Code/mixue.png')
